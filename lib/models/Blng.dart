...
class Blng extends amplify_core.Model {
  ...
  const Blng._internal({required this.id, weeklySheet, required status, createdAt, updatedAt}): _weeklySheet = weeklySheet, _status = status, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Blng({String? id, List<String>? weeklySheet, required String status}) {
  ...
  Blng copyWith({List<String>? weeklySheet, String? status}) {
    return Blng._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'weeklySheet': _weeklySheet, 'status': _status, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
